export 'package:fl_comunicacion/views/new_comment_view.dart';
...
export 'package:fl_comunicacion/views/feed_view.dart';
export 'package:fl_comunicacion/views/post_view.dart';
