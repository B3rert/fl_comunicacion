...
//
//     final postResModel = postResModelFromMap(jsonString);
...
class PostResModel {
  ...
  factory PostResModel.fromJson(String str) =>
      PostResModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PostResModel.fromMap(Map<String, dynamic> json) => PostResModel(
        tarea: json["tarea"],
        ...
        tareaPadre:
            json["tarea_Padre"].toString() == "{}" ? null : json["tarea_Padre"],
